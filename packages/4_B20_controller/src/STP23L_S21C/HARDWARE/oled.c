...
void oled_show(void)
{
	...
	/*     第一行串口2测距距离显示     */
		OLED_ShowString(0,0,"Distance1:");
		OLED_ShowString(110,0,"mm"),
		OLED_ShowNumber(68,0,distance_1,5,12);
  /*     第二行串口3测距距离显示     */
		OLED_ShowString(0,10,"Distance2:");	
		OLED_ShowString(110,10,"mm"),
		OLED_ShowNumber(68,10,distance_2,5,12);
	/*     第三行串口4测距距离显示     */
		OLED_ShowString(0,20,"Distance3:");
		OLED_ShowString(110,20,"mm"),
		OLED_ShowNumber(68,20,distance_3,5,12);
	/*     第四行串口5测距距离显示     */
		OLED_ShowString(0,30,"Distance4:");	
		OLED_ShowString(110,30,"mm"),
		OLED_ShowNumber(68,30,distance_4,5,12);
		OLED_Refresh_Gram();
}
