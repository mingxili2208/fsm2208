...
//			nrt_ctl_info->acceleration=0;
			...
			AX_Delayms(20);
			AX_BEEP_Off();
			AX_OLED_DispValue(0,  1,tmp_buf[0], 6, 0, 0);
			AX_OLED_DispValue(30, 1,tmp_buf[1], 6, 0, 0);
			AX_OLED_DispValue(60, 1,tmp_buf[8], 6, 0, 0);
			AX_OLED_DispValue(90, 1,tmp_buf[9], 6, 0, 0);
		}
