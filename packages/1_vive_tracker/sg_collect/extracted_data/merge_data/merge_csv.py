...
if __name__ == "__main__":
    ...
    # 输入文件1的路径
    input_file_1 = "/home/cityu-fsm-lab-carla/lmx/packages/1_vive_tracker/sg_collect/extracted_data/merge_data/synchronized_raw_data_c.csv"
    
    # 输入文件2的路径
    input_file_2 = "/home/cityu-fsm-lab-carla/lmx/packages/1_vive_tracker/sg_collect/extracted_data/merge_data/synchronized_raw_data_n.csv"
    
    # 输出文件的路径和名称
    output_file = "/home/cityu-fsm-lab-carla/lmx/packages/1_vive_tracker/sg_collect/extracted_data/merge_data/synchronized_raw_data.csv"
