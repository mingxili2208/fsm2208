...
def main():
    ...
    carla_root_path = os.getenv('CARLA_ROOT')
    relative_egg_path = 'PythonAPI/carla/dist/carla-0.9.15-py3.10-linux-x86_64.egg'
    egg_file = os.path.join(carla_root_path, relative_egg_path)
