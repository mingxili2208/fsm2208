...
class AutowareGoalPublisher(Node):
    ...
    def __init__(self):
        ...
        # Parameters
        self.distance_threshold = 8.0  # 1 meter threshold for goal detection
...
class IntegratedManager:
    ...
    def run_npc_test_sequence(self):
        ...
        logging.info("Waiting 1 seconds before sending engage command...")
        ...
        # 4. Wait 5 seconds at end point
        logging.info("Waiting 5 seconds at end point...")
        time.sleep(5)
