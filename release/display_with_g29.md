...
```bash
    ...
    python3 coordinate_publisher_with_rbf.py
```
...
```bash
    ...
    cd /home/cityu-fsm-lab-carla/lmx/packages/b_scaled_model/G29_wheel/release/
    
    python3 g29_release.py
...
```sh
    ...
    bash integrated_scenario_launcher.sh
