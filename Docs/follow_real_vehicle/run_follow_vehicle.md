# this is about how to start transformation and following functions

0. before every commond u need to type in the following codes
...
1. open the subscriber node

    ```s
    cd ~/lmx/source_code/follow_real_vehicle
    python3 debug_carla_coor.py
    ```

2. open the publisher node

    ```s
    cd ~/lmx/source_code/tracker2carla
    python3 transformed_world_coor_publisher.py
    ```
