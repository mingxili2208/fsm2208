...
export AGENT_ROLE_NAME="remote_npc_vehicle" #############################################pygame-adtruck
...
export FREE_AGENT_POSE="0.593466,0.4899632,0.000016,0,0,19.2" 
...
python3 /home/cityu-fsm-lab-carla/lmx/Docs/packages/autoware_comm/scripts/test/test_remote_npc_vehicle_launcher.py
