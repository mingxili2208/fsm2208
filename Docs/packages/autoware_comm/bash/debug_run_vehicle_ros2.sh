...
export AGENT_MODEL_TYPE="vehicle.dodge.charger_police" #"vehicle.tesla.cybertruck" # "vehicle.mitsubishi.fusorosa" #"vehicle.tesla.cybertruck" #"vehicle.mitsubishi.fusorosa" #"vehicle.dodge.charger_police"   #"vehicle.tesla.model3"
