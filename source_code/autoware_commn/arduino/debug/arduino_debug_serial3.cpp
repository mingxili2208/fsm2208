...
//   Serial.println();
// }
int map_speed_sigmoid(float speed, float min_speed = 0.05, float max_speed = 1.8, float min_mapped = 40, float max_mapped = 55) {
  // 设置速度阈值
  if (speed <= 0.05) {
    return 0;
  }
