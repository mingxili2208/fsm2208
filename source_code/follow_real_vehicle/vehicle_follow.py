...
class CarlaVehicleFollowRCHandler(Node):
    """
    Class to follow the vehicle of real_world.
    """
    def __init__(self,role_name="pygame_adtruck"):

        super().__init__('CarlaVehicleFollowRCHandler_Node')
...
if __name__ == "__main__":
    ...
    following_handler = CarlaVehicleFollowRCHandler(role_name)
    ...
    try:
        ...
        following_handler.run()
    except Exception as e:
        following_handler.get_logger().fatal(f"node_destroy")
        following_handler.stop()
        traceback.print_exc()
