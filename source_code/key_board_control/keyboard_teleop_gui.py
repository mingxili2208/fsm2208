...
class KeyboardTeleop(Node):
    ...
    def __init__(self):
        ...
        self.root.title("Keyboard Teleop")
        ...
        self.speed_label = Label(self.frame, text=f"Speed: 0.00 m/s")
        self.speed_label.pack()

        self.steering_angle_label = Label(self.frame, text=f"Steering Angle: 0.00 rad")
    ...
    def publish_cb(self):
        ...
        with state_lock:
            ...
            self.speed_label.config(text=f"Speed: {ack.drive.speed:.2f} m/s")
            self.steering_angle_label.config(text=f"Steering Angle: {ack.drive.steering_angle:.2f} rad")
